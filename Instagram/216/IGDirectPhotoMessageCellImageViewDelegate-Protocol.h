...
@class IGDirectPhotoMessageCell, IGImageRequestSummary, IGImageViewLoadingState, NSError, NSString, UIImage;
...
- (void)directPhotoMessageCell:(IGDirectPhotoMessageCell *)arg1 didUpdateLoadingState:(IGImageViewLoadingState *)arg2;
