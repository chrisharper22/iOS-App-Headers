...
@class FB_RTCCertificate, FB_RTCCryptoOptions, FB_RTCIntervalRange, NSArray, NSNumber;
...
@interface FB_RTCConfiguration : NSObject
{
    ...
    NSArray *_iceServers;
    FB_RTCCertificate *_certificate;
    ...
    FB_RTCIntervalRange *_iceRegatherIntervalRange;
    long long _sdpSemantics;
    struct TurnCustomizer *_turnCustomizer;
    FB_RTCCryptoOptions *_cryptoOptions;
}
...
@property(retain, nonatomic) FB_RTCCryptoOptions *cryptoOptions; // @synthesize cryptoOptions=_cryptoOptions;
...
@property(retain, nonatomic) FB_RTCIntervalRange *iceRegatherIntervalRange; // @synthesize iceRegatherIntervalRange=_iceRegatherIntervalRange;
...
@property(retain, nonatomic) FB_RTCCertificate *certificate; // @synthesize certificate=_certificate;
@property(copy, nonatomic) NSArray *iceServers; // @synthesize iceServers=_iceServers;
- (void *)createNativeConfiguration;
- (id)description;
- (id)initWithNativeConfiguration:(const void *)arg1;
- (id)init;
