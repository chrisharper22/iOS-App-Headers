...
#import "FB_RTCAudioSessionActivationDelegate-Protocol.h"
...
@interface FB_RTCAudioSession : NSObject <FB_RTCAudioSessionActivationDelegate>
{
    ...
    struct AsyncInvoker _asyncInvoker;
    _Bool _enableMediaServicesResetFixes;
    _Bool _enableSetNumChannelsFix;
    _Bool _ignoresPreferredAttributeConfigurationErrors;
    vector_d094a3c3 _delegates;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic, getter=isEnableSetNumChannelsFix) _Bool enableSetNumChannelsFix; // @synthesize enableSetNumChannelsFix=_enableSetNumChannelsFix;
@property(nonatomic, getter=isEnableMediaServicesResetFixes) _Bool enableMediaServicesResetFixes; // @synthesize enableMediaServicesResetFixes=_enableMediaServicesResetFixes;
@property(readonly, nonatomic) AVAudioSession *session; // @synthesize session=_session;
- (void)addMarkerPoint:(id)arg1 data:(id)arg2;
- (void)endQplTrace;
- (void)startQplTrace;
- (id)getPortsInfo:(id)arg1;
- (void)setLastResetTime:(long long)arg1;
- (void)_resetAudioSessionWithRetries:(unsigned long long)arg1 currentAttempt:(unsigned long long)arg2 retryIntervalMs:(unsigned long long)arg3 fullReset:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
- (void)resetAudioSessionWithRetries:(unsigned long long)arg1 retryIntervalMs:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) vector_d094a3c3 delegates; // @synthesize delegates=_delegates;
...
- (id)init;
- (_Bool)setConfiguration:(id)arg1 active:(_Bool)arg2 shouldSetActive:(_Bool)arg3 afterEvent:(_Bool)arg4 error:(id *)arg5;
- (_Bool)setConfigurationAfterEvent:(id)arg1 active:(_Bool)arg2 error:(id *)arg3;
