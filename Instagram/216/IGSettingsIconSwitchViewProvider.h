...
@class IGSwitch, IGTableLayoutSpec, NSString, UIImageView, UILabel;
@protocol IGListItemViewProviderDelegate, IGSettingsIconSwitchViewProviderDelegate;

@interface IGSettingsIconSwitchViewProvider : NSObject <IGListItemViewProvider>
{
    ...
    id <IGSettingsIconSwitchViewProviderDelegate> _delegate;
    struct UIEdgeInsets _leadingViewInsets;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <IGSettingsIconSwitchViewProviderDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)setImage:(id)arg1 title:(id)arg2 switchIsOn:(_Bool)arg3;
