...
@protocol IGARLocationEffectsFeedDataSourceListener;

@protocol IGARLocationEffectsFeedDataSource <NSObject>
...
- (void)removeListener:(id <IGARLocationEffectsFeedDataSourceListener>)arg1;
- (void)addListener:(id <IGARLocationEffectsFeedDataSourceListener>)arg1;
- (void)prefetch;
- (void)fetchMore;
- (void)fetch;
@end
