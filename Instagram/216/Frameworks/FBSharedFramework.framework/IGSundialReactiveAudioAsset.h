...
@class IGSundialReactiveAudioAssetParser, IGSundialReactiveAudioTrackInfo, IGUser, NSArray, NSString, NSURL;

@interface IGSundialReactiveAudioAsset : NSObject <IGSundialAudioAssetProtocol>
{
    IGSundialReactiveAudioAssetParser *_parser;
    NSString *_subtitle;
    ...
    NSURL *_reactiveAudioFileURL;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSURL *reactiveAudioFileURL; // @synthesize reactiveAudioFileURL=_reactiveAudioFileURL;
...
@property(readonly, nonatomic) IGSundialReactiveAudioTrackInfo *reactiveAudioTrackInfo;
- (id)initWithPk:(id)arg1 audioClusterId:(id)arg2 title:(id)arg3 artistName:(id)arg4 albumArtURL:(id)arg5 albumArtThumbnailURL:(id)arg6 audioFileURL:(id)arg7 reactiveAudioFileURL:(id)arg8 highlightTimes:(id)arg9 durationInMilliseconds:(long long)arg10 isExplicit:(_Bool)arg11 hasLyrics:(_Bool)arg12 allowsSaving:(_Bool)arg13 isBookmarked:(_Bool)arg14 shouldAllowMediaCreationWithMusic:(_Bool)arg15 isTrending:(_Bool)arg16 videoCountString:(id)arg17;
- (id)initWithReactiveAudioAssetParser:(id)arg1;
