...
@class IGAudioMusicTrack, IGBigAlbumArtMusicSticker, IGStoryStickerExportModel, NSString, UIColor;

@interface IGStoryMusicAlbumArtStickerView : UIView <IGStickerViewType, IGStoryMusicStickerProtocol, IGDynamicSurfaceStickerViewType>
{
