...
- (void).cxx_destruct;
@property(retain, nonatomic) NSDictionary *dialogFlows; // @synthesize dialogFlows=_dialogFlows;
@property(retain, nonatomic) NSDictionary *dialogConfigurations; // @synthesize dialogConfigurations=_dialogConfigurations;
