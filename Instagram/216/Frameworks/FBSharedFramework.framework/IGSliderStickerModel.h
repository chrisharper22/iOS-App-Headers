...
- (id)diffIdentifier;
- (id)initWithPk:(id)arg1 question:(id)arg2 emojiUnicode:(id)arg3 textColor:(id)arg4 backgroundColor:(id)arg5 viewerCanVote:(_Bool)arg6 viewerVote:(id)arg7 averageVote:(id)arg8 voteCount:(id)arg9 tapStateId:(id)arg10;
