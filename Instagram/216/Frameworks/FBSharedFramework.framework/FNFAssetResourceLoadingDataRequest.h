...
@interface FNFAssetResourceLoadingDataRequest : NSObject
{
    ...
    CDUnknownBlockType _sendHeadersCallback;
    _Bool _isAudio;
    _Bool _firstRequest;
    _Bool _isForDiskCache;
    _Bool _isPredictive;
    _Bool _isHeaderOnly;
    _Bool _disableDiskCaching;
    int _sequenceIndex;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool disableDiskCaching; // @synthesize disableDiskCaching=_disableDiskCaching;
...
- (void)respondWithHeaders:(id)arg1;
- (void)respondWithData:(id)arg1;
- (id)initWithRequestedOffset:(long long)arg1 requestedLength:(long long)arg2 dataCallback:(CDUnknownBlockType)arg3 headersCallback:(CDUnknownBlockType)arg4 isPredictive:(_Bool)arg5;
