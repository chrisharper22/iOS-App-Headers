...
@interface FNFResponseMetadata : NSObject
{
    ...
    long long _nextValidSegmentId;
    NSNumber *_clockOffsetMs;
}

- (void).cxx_destruct;
@property(readonly, copy, nonatomic) NSNumber *clockOffsetMs; // @synthesize clockOffsetMs=_clockOffsetMs;
@property(readonly, nonatomic) long long nextValidSegmentId; // @synthesize nextValidSegmentId=_nextValidSegmentId;
