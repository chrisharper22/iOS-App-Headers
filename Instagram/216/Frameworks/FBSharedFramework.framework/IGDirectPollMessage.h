...
@class IGDirectEmbeddedPublishedMessage, IGDirectForwardMetadata, IGDirectPollMessageXMA, IGDirectPowerupsMetadata, IGDirectUIMessageMetadata, NSArray, NSString;

@interface IGDirectPollMessage : FBValueObject <IGDirectUIMessage, NSCopying, NSCoding>
{
    _Bool _isShhMode;
    IGDirectPollMessageXMA *_pollMessageXma;
...
@property(readonly, copy, nonatomic) IGDirectPollMessageXMA *pollMessageXma; // @synthesize pollMessageXma=_pollMessageXma;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithPollMessageXma:(id)arg1 metadata:(id)arg2 quotedMessage:(id)arg3 reactions:(id)arg4 isShhMode:(_Bool)arg5;
