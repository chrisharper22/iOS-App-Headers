...
@class IGDirectEmbeddedPublishedMessage, IGDirectForwardMetadata, IGDirectPowerupsMetadata, IGDirectStatusReplyContent, IGDirectStatusReplyContext, IGDirectUIMessageMetadata, NSArray, NSString;

@interface IGDirectStatusReply : NSObject <IGDirectUIMessage>
{
    _Bool _isShhMode;
...
- (id)initWithMetadata:(id)arg1 content:(id)arg2 context:(id)arg3 reactions:(id)arg4 isShhMode:(_Bool)arg5;
