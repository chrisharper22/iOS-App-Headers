...
@class IGDirectEmbeddedPublishedMessage, IGDirectForwardMetadata, IGDirectPowerupsMetadata, IGDirectUIMessageMetadata, NSArray, NSNumber, NSString;

@interface IGDirectHashtagShare : NSObject <IGDirectUIMessage, IGDirectShareProtocol>
{
    _Bool _isShhMode;
...
- (id)initWithMetadata:(id)arg1 hashtagName:(id)arg2 comment:(id)arg3 previewMedia:(id)arg4 mediaCount:(id)arg5 reactions:(id)arg6 isShhMode:(_Bool)arg7;
