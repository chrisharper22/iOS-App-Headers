...
@interface IGStoryCreativeAssetsParser : NSObject <IGNetworkParser>
{
    ...
    IGStoryCreativeAssetsParserConfiguration *_configuration;
...
- (id)initWithStoryStickerObjectStorage:(id)arg1 configuration:(id)arg2 objectStores:(id)arg3 interopFeatureGating:(id)arg4 launcherSetProvider:(id)arg5;
