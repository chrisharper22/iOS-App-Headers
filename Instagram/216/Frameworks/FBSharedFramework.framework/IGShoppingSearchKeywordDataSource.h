...
@class IGSearchNetworkDataSource, IGSearchServerResultsStore, IGUserSession, NSString;
@protocol IGSearchNetworkDataProviderDelegate;

@interface IGShoppingSearchKeywordDataSource : NSObject <IGSearchNetworkDataProviderDelegate, IGSearchNetworkDataProvider>
{
...
- (id)_buildBasicResponseFromResults:(id)arg1 seeMoreItems:(id)arg2;
...
- (void)_bootstrapNullStateWithSessionID:(id)arg1;
- (void)_handleClientSideMatching:(id)arg1;
- (void)fetchDataForSearchQueryModel:(id)arg1;
- (id)initWithUserSession:(id)arg1 networkDataSource:(id)arg2 serverResultsStore:(id)arg3;
