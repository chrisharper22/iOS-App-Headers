...
- (id)uploadContentSource:(id)arg1 toURL:(id)arg2 offset:(unsigned long long)arg3 streamAnnouncer:(id)arg4 dataCenter:(id)arg5 isDuplicate:(_Bool)arg6 config:(id)arg7 offProcessKey:(id)arg8 withSuccess:(CDUnknownBlockType)arg9 failure:(CDUnknownBlockType)arg10 cancellation:(CDUnknownBlockType)arg11 progress:(CDUnknownBlockType)arg12;
