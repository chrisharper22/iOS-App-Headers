...
@interface IGTrackStabilizer : NSObject <IGTrackStabilizerProtocol>
{
    ...
    double _maxZoom;
    struct vector<IGOrientationSample, std::allocator<IGOrientationSample>> _cameraOrientations;
    struct vector<boost::qvm::quat<double>, std::allocator<boost::qvm::quat<double>>> _stabilizedFrameOrientations;
