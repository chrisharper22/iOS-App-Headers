...
@class IGNetworkSpeedProvider, NSDictionary, NSString;

@interface IGAdaptiveImageDownloadNetworkSpeedJPEGStrategy : NSObject <MOSAdaptiveImageDownloadStrategyProtocol>
{
...
- (id)initWithNetworkSpeedProvider:(id)arg1 scansProfileThresholdConfigs:(id)arg2;
