...
- (id)diffIdentifier;
- (id)initWithPk:(id)arg1 giphyId:(id)arg2 verifiedUsername:(id)arg3 url:(id)arg4 highQualityUrl:(id)arg5 mp4Url:(id)arg6 width:(double)arg7 height:(double)arg8 includeInRecent:(_Bool)arg9 isSticker:(_Bool)arg10 title:(id)arg11;
