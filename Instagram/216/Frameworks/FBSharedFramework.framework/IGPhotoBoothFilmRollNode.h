...
@class IGGLKContext, IGGLKTexture2D, IGPhotoBoothBoxBlurRenderer, IGPhotoBoothFilmRollCompositeRenderer, IGPhotoBoothFilmRollRenderer, IGPhotoBoothGaussianBlurRenderer, NSArray, NSString;

@interface IGPhotoBoothFilmRollNode : IGGLKNode <IGPhotoBoothVariantNode>
{
    float *_exposureValues;
    float *_offsetYValues;
    unsigned long long _currentFrameIndex;
    unsigned long long _currentTextureIndex;
    IGPhotoBoothFilmRollRenderer *_filmRollRenderer;
    IGPhotoBoothBoxBlurRenderer *_boxBlurRenderer;
    IGPhotoBoothGaussianBlurRenderer *_gaussianBlurRenderer;
    IGPhotoBoothFilmRollCompositeRenderer *_compositeRenderer;
