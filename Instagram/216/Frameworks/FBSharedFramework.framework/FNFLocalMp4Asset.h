...
- (_Bool)_isDroppableFrame:(struct opaqueCMSampleBuffer *)arg1;
...
- (void)_processLoadAssetErrorWitHandler:(CDUnknownBlockType)arg1 outHandler:(CDUnknownBlockType)arg2 errMsg:(id)arg3 assetErrorCode:(int)arg4;
...
- (id)initWithLocalURL:(id)arg1 decompressedOutput:(_Bool)arg2 containerDimensions:(struct CGSize)arg3 shouldApplyRotationTransform:(_Bool)arg4 enableDroppableFrames:(_Bool)arg5;
