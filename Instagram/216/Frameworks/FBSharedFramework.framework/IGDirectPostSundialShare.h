...
@class IGAdItem, IGDirectEmbeddedPublishedMessage, IGDirectForwardMetadata, IGDirectPowerupsMetadata, IGDirectUIMessageMetadata, IGMedia, NSArray, NSString;
...
- (id)initWithMetadata:(id)arg1 comment:(id)arg2 post:(id)arg3 adItem:(id)arg4 reactions:(id)arg5 isShhMode:(_Bool)arg6 forwardMetadata:(id)arg7;
