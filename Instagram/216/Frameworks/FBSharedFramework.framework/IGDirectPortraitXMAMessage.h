...
@class IGDirectEmbeddedPublishedMessage, IGDirectForwardMetadata, IGDirectPortraitXMA, IGDirectPowerupsMetadata, IGDirectUIMessageMetadata, NSArray, NSString;

@interface IGDirectPortraitXMAMessage : FBValueObject <IGDirectUIMessage, NSCopying, NSCoding>
{
    _Bool _isShhMode;
...
@property(readonly, copy, nonatomic) IGDirectPortraitXMA *portraitXma; // @synthesize portraitXma=_portraitXma;
@property(readonly, copy, nonatomic) IGDirectUIMessageMetadata *metadata; // @synthesize metadata=_metadata;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithMetadata:(id)arg1 portraitXma:(id)arg2 quotedMessage:(id)arg3 reactions:(id)arg4 isShhMode:(_Bool)arg5;
