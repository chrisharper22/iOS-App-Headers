...
@class CAShapeLayer, IGGradientView, IGStoryStickerExportModel, IGTextView, IGTooltipView, NSArray, NSDictionary, NSNumber, NSString, UICollectionView, UITapGestureRecognizer;
@protocol IGQuizStickerViewDelegate;

@interface IGQuizStickerView : UIView <UITextViewDelegate, IGQuizStickerOptionCellDelegate, UICollectionViewDataSource, UICollectionViewDelegate, IGStickerViewType, IGConstrainedSizeStickerViewType, IGSpecialBurnedInContentStickerViewType, IGEditableStickerViewType>
{
...
- (id)_initCreationViewWithQuestion:(id)arg1 hasEditedQuestion:(_Bool)arg2 options:(id)arg3 correctOption:(unsigned long long)arg4 colorScheme:(unsigned long long)arg5 userSession:(id)arg6;
