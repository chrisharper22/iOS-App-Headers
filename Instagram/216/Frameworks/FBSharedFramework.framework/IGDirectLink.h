...
@class IGDirectEmbeddedPublishedMessage, IGDirectForwardMetadata, IGDirectLinkContext, IGDirectPowerupsMetadata, IGDirectUIMessageMetadata, NSArray, NSString;

@interface IGDirectLink : NSObject <IGDirectUIMessage>
{
    _Bool _isShhMode;
...
- (id)initWithMetadata:(id)arg1 text:(id)arg2 linkContext:(id)arg3 reactions:(id)arg4 forwardMetadata:(id)arg5 isShhMode:(_Bool)arg6;
