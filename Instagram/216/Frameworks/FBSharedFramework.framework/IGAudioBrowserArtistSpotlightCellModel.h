...
@interface IGAudioBrowserArtistSpotlightCellModel : NSObject <IGAudioBrowserListCellModel>
{
...
- (id)diffIdentifier;
- (id)initWithUUID:(id)arg1 tracks:(id)arg2 embeddedAudioType:(long long)arg3;
