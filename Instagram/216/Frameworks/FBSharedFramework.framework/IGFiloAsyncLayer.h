...
@protocol IGSynchronousScheduler><IGBarrierScheduler;

@interface IGFiloAsyncLayer : IGFiloLayer
{
    IGFiloLayer *_nextLayer;
    id <IGSynchronousScheduler><IGBarrierScheduler> _scheduler;
}
...
- (id)initWithIdentifier:(id)arg1 targetScheduler:(id)arg2 nextLayer:(id)arg3;
