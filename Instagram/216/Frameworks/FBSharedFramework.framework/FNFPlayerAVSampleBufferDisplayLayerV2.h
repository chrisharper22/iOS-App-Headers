...
@interface FNFPlayerAVSampleBufferDisplayLayerV2 : AVSampleBufferDisplayLayer <FNFDecompressionSessionDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer>
{
    ...
    struct priority_queue<long long, std::vector<long long>, std::greater<long long>> _enqueuedFramesPTS;
    ...
    _Bool _enqueueOnMainThread;
    _Bool _enqueueOnRenderingThread;
    _Bool _enqueueOnStateQueue;
    _Bool _enableRecycler;
...
- (void)_requestData;
- (void)_enqueueSampleBuffer:(struct __CVBuffer *)arg1 presentationTimeStamp:(CDStruct_1b6d18a9)arg2 presentationDuration:(CDStruct_1b6d18a9)arg3;
- (_Bool)isReadyForMoreMediaData;
- (_Bool)_enqueuedFramesSizeFull;
...
- (_Bool)flushIfError;
- (_Bool)_isFrameOnClose:(unsigned long long)arg1;
- (void)_setFrameOnClose;
- (_Bool)_doesIFrameBelongsToDecompressionSession:(unsigned long long)arg1;
- (void)_resetDecompressionSessionIndex;
...
- (void)dispatchForSuper:(CDUnknownBlockType)arg1;
