...
@interface FBPayActionButtonCellViewModel : NSObject <FBPayBaseCellViewModel>
{
...
@property(readonly, nonatomic) UIView *actionButton; // @synthesize actionButton=_actionButton;
- (id)initWithActionButton:(id)arg1 edgeInsets:(struct UIEdgeInsets)arg2 reuseIdentifier:(id)arg3;
