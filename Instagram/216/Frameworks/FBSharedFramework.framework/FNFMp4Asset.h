...
#import <FBSharedFramework/FNFAtomManagerDelegate-Protocol.h>
#import <FBSharedFramework/FNFDataLoaderDelegate-Protocol.h>
#import <FBSharedFramework/FNFInfoForLoopableAsset-Protocol.h>
#import <FBSharedFramework/FNFTimeLoadedDelegate-Protocol.h>
...
- (id)initWithURL:(id)arg1 config:(CDStruct_a14c44a6)arg2 dispatchQueue:(id)arg3 isAsync:(_Bool)arg4;
...
- (id)initWithURL:(id)arg1 config:(CDStruct_a14c44a6)arg2;
- (id)initWithURL:(id)arg1 config:(CDStruct_a14c44a6)arg2 eventListener:(id)arg3;
