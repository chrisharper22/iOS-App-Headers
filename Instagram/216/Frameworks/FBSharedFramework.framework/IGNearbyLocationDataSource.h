...
@protocol IGNearbyLocationDataSourceDelegate, IGRequestToken, IGSearchThrottlingType;
...
@interface IGNearbyLocationDataSource : NSObject <UITableViewDataSource>
{
    ...
    _Bool _lastResponseReducedAccuracy;
    _Bool _locationIsFromEXIF;
    _Bool _reducedLocationAccuracy;
    NSArray *_locations;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool reducedLocationAccuracy; // @synthesize reducedLocationAccuracy=_reducedLocationAccuracy;
@property(nonatomic) _Bool locationIsFromEXIF; // @synthesize locationIsFromEXIF=_locationIsFromEXIF;
@property(nonatomic) _Bool lastResponseReducedAccuracy; // @synthesize lastResponseReducedAccuracy=_lastResponseReducedAccuracy;
...
- (void)_handleLocationFetchSuccess:(id)arg1 queryText:(id)arg2 rankToken:(id)arg3 reducedAccuracy:(_Bool)arg4;
...
- (void)_initGroupsFromResponse:(id)arg1 reducedAccuracy:(_Bool)arg2;
