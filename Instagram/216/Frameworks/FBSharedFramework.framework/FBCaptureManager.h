...
#import <FBSharedFramework/FBCCAudioPipelineRuntimeErrorDelegate-Protocol.h>
...
@class AVCaptureAudioDataOutput, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureVideoPreviewLayer, FBAVAudioDataProducer, FBAVPOIDataProducer, FBAVVideoDataProducer, FBCameraAudioLevelListenerAnnouncer, FBCameraCaptureFrameDropQueuedAnnouncer, FBCameraCaptureManagingProducerPorts, FBCameraProductionDebugLogger, FBCaptureDevice, FBCaptureDeviceStateController, FBCaptureFlashSceneDetector, FBCaptureLowLightDetector, FBCaptureManagerEventQueuedAnnouncer, FBCaptureManagerFlashSceneEventQueuedAnnouncer, FBCaptureManagerPOIDetectorEventQueuedAnnouncer, FBCapturePOIDetector, FBCaptureSession, FBCaptureVideoDataOutput, FBFramePerformanceTracker, FBSystemCaptureDeviceObserver, NSArray, NSString;
@protocol FBAudioCapturerProtocol><AVCaptureAudioDataOutputSampleBufferDelegate><FBCCAudioPipelineCapturing, FBCCAudioCaptureControlling, FBCCExperimentManager, FBCCMediaEventWaterfallLogging, FBCCPerformanceLogger, FBCCWaterfallLoggingComponent, FBCameraAnalyticsPayloadProviding, FBCaptureDeviceFormatProvider, FBCaptureOutput, FBCaptureVideoSessionControlling, FBDepthDataManager, FBMPProducerPort, FBOrientationTracking, FBSystemAudioCaptureSessionInteracting, OS_dispatch_queue;

@interface FBCaptureManager : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, FBAudioBufferHandler, FBCaptureSessionStateDelegate, FBCaptureSessionRuntimeErrorDelegate, FBCaptureLowLightDetectorDelegate, FBCaptureFlashSceneDetectorDelegate, FBCaptureVideoSessionControlling, FBCCAudioCaptureControlling, FBDepthDataManagerDelegate, FBCCAudioPipelineRuntimeErrorDelegate, FBCameraCaptureManaging>
{
    ...
    id <FBCCMediaEventWaterfallLogging> _waterfallLogger;
    ...
    long long _audioPortConnections;
    id <FBCCWaterfallLoggingComponent> _waterfallLoggingComponent;
    ...
    FBCaptureSession *_videoCaptureSession;
...
@property(retain, nonatomic) FBCaptureSession *videoCaptureSession; // @synthesize videoCaptureSession=_videoCaptureSession;
...
- (void)didEncounterAudioPipelineRuntimeError:(id)arg1;
...
- (void)_didFinishConfiguringAudioCaptureSessionInputOutput;
...
- (void)_configureAudioCaptureSessionInputOutput;
...
- (void)_logWaterfallCameraEvent:(id)arg1 mediaType:(unsigned long long)arg2 extras:(id)arg3 error:(id)arg4;
...
- (_Bool)_setCaptureDevices:(id)arg1;
