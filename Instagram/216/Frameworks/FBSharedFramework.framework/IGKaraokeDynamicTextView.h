...
@class NSArray, NSString, UICollectionView, UIColor, UIFont, UIPanGestureRecognizer;

@interface IGKaraokeDynamicTextView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, IGDynamicTextViewProtocol>
{
    UIFont *_activeFont;
