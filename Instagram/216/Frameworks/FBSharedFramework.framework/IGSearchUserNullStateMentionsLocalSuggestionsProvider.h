...
#import <FBSharedFramework/IGSearchLocalSuggesting-Protocol.h>

@class NSString;

@interface IGSearchUserNullStateMentionsLocalSuggestionsProvider : NSObject <IGSearchLocalSuggesting>
{
