...
+ (void)configureWithTokenCache:(id)arg1 graphRequestConnectionFactory:(id)arg2 graphRequestPiggybackManager:(Class)arg3;
+ (void)setGraphRequestPiggybackManager:(Class)arg1;
+ (Class)graphRequestPiggybackManager;
+ (void)setGraphRequestConnectionFactory:(id)arg1;
+ (id)graphRequestConnectionFactory;
+ (void)refreshCurrentAccessTokenWithCompletion:(CDUnknownBlockType)arg1;
+ (_Bool)isCurrentAccessTokenActive;
+ (void)setCurrentAccessToken:(id)arg1 shouldDispatchNotif:(_Bool)arg2;
