...
@protocol FNFBandwidthProvider, FNFDashHeading, FNFDashTrackEntryContaining><FNFDashVirtualEntryContaining;
...
- (void)_jumpToEndFromSequence:(int)arg1 withPlaybackTime:(CDStruct_1b6d18a9)arg2;
- (_Bool)_shouldJumpToEndWithInitialCount:(int)arg1 atPlaybackTime:(CDStruct_1b6d18a9)arg2;
...
- (id)representationId;
- (id)description;
- (id)initWithConfig:(struct FNFDashConfig)arg1 sessionConfig:(CDStruct_c72663c7)arg2 trackMetadata:(id)arg3 containerFormat:(unsigned char)arg4 trackMetadataIsFinal:(_Bool)arg5 containsCompleteTimeline:(_Bool)arg6 track:(long long)arg7 bandwidthProvider:(id)arg8 playerMetadata:(id)arg9 source:(unsigned long long)arg10;
