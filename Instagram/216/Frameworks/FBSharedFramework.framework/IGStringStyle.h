...
@interface IGStringStyle : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _skipColorStyling;
    _Bool _skipFontStyling;
    _Bool _skipParagraphStyling;
    long long _lineBreakMode;
    _Bool _avoidCoreTextAttributes;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool avoidCoreTextAttributes; // @synthesize avoidCoreTextAttributes=_avoidCoreTextAttributes;
...
@property(readonly, nonatomic) _Bool skipColorStyling; // @synthesize skipColorStyling=_skipColorStyling;
