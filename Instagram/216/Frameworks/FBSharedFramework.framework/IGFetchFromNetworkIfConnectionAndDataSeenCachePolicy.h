...
@interface IGFetchFromNetworkIfConnectionAndDataSeenCachePolicy : NSObject <IGCachePolicy>
{
    ...
    id <IGCachePolicy> _writePolicy;
    CDUnknownBlockType _isDataStale;
    CDUnknownBlockType _isDataValidToCache;
}
...
- (id)metadata;
- (id)initWithMetadata:(id)arg1 isDataStale:(CDUnknownBlockType)arg2 isDataValidToCache:(CDUnknownBlockType)arg3;
