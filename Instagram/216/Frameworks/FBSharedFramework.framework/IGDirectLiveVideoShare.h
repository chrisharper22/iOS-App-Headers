...
@interface IGDirectLiveVideoShare : NSObject <IGDirectUIMessage, IGMediaViewerSpecifierProvider>
{
    long long _textType;
    _Bool _isShhMode;
...
- (id)initWithMetadata:(id)arg1 broadcast:(id)arg2 comment:(id)arg3 textType:(long long)arg4 startPlaybackAtOffset:(long long)arg5 reactions:(id)arg6 isShhMode:(_Bool)arg7;
