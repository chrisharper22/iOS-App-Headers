...
@class NSString;
@protocol FBARNativeUIControlServiceEffectDescriptor, FBARParticipantServiceDelegate;

@interface FBARParticipantServiceConfiguration : NSObject <FBARServiceConfiguration, FBARServiceConfigurationCxx>
{
    id <FBARNativeUIControlServiceEffectDescriptor> _effectDescriptor;
    id <FBARParticipantServiceDelegate> _delegate;
}

+ (_Bool)supportsSecureCoding;
+ (id)newWithEffectDescriptor:(id)arg1 delegate:(id)arg2;
- (void).cxx_destruct;
@property(readonly, nonatomic) __weak id <FBARParticipantServiceDelegate> delegate; // @synthesize delegate=_delegate;
...
- (id)initWithEffectDescriptor:(id)arg1 delegate:(id)arg2;
