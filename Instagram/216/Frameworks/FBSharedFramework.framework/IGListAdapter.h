...
#import <FBSharedFramework/IGCollectionViewLayoutDataSource-Protocol.h>
#import <FBSharedFramework/IGCollectionViewLayoutSeparatorDelegate-Protocol.h>
#import <FBSharedFramework/IGListBatchContext-Protocol.h>
#import <FBSharedFramework/IGListCollectionContext-Protocol.h>
#import <FBSharedFramework/IGListCollectionViewDelegateLayout-Protocol.h>
#import <FBSharedFramework/UICollectionViewDataSource-Protocol.h>

@class IGAutomaticGraphItemsTracker, IGListAdapterProxy, IGListDisplayHandler, IGListSectionMap, IGListWorkingRangeHandler, NSHashTable, NSMapTable, NSMutableArray, NSMutableSet, NSString, UICollectionView, UIView, UIViewController;
@protocol IGListAdapterDataSource, IGListAdapterDelegate, IGListAdapterMoveDelegate, IGListAdapterPerformanceDelegate, IGListUpdatingDelegate, UICollectionViewDelegate, UIScrollViewDelegate;

@interface IGListAdapter : NSObject <UICollectionViewDataSource, IGListCollectionViewDelegateLayout, IGCollectionViewLayoutDataSource, IGCollectionViewLayoutSeparatorDelegate, IGListCollectionContext, IGListBatchContext>
{
    ...
    id <IGListAdapterPerformanceDelegate> _performanceDelegate;
...
@property(nonatomic) __weak id <IGListAdapterPerformanceDelegate> performanceDelegate; // @synthesize performanceDelegate=_performanceDelegate;
...
- (void)invalidateLayoutInSectionController:(id)arg1 atIndexes:(id)arg2;
...
- (void)_invalidateLayoutForSectionController:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)fullyVisibleCellsForSectionController:(id)arg1;
...
@property(readonly, nonatomic) struct IGListCollectionScrollingTraits scrollingTraits;
@property(readonly, nonatomic) struct CGPoint containerContentOffset;
...
- (id)_sectionControllerForCell:(id)arg1;
- (id)sectionControllerForView:(id)arg1;
- (void)mapView:(id)arg1 toSectionController:(id)arg2;
- (id)_layoutAttributesForSupplementaryViewOfKind:(id)arg1 atIndexPath:(id)arg2;
- (id)_layoutAttributesForItemAtIndexPath:(id)arg1;
- (id)_layoutAttributesForItemAndSupplementaryViewAtIndexPath:(id)arg1 supplementaryKinds:(id)arg2;
...
- (struct OffsetRange)_offsetRangeForIndexPath:(id)arg1 supplementaryKinds:(id)arg2 scrollDirection:(long long)arg3;
- (double)offsetForFirstVisibleItemWithScrollDirection:(long long)arg1;
- (id)indexPathForFirstVisibleItem;
- (void)scrollToObject:(id)arg1 supplementaryKinds:(id)arg2 scrollDirection:(long long)arg3 scrollPosition:(unsigned long long)arg4 additionalOffset:(double)arg5 animated:(_Bool)arg6;
...
@property(retain, nonatomic) IGAutomaticGraphItemsTracker *automaticGraphItemsTracker;
...
- (id)initWithUserFeatureSets:(id)arg1 module:(id)arg2 viewController:(id)arg3 workingRange:(unsigned long long)arg4 sectionMovesAsDeletesInserts:(_Bool)arg5;
- (id)initWithUserFeatureSets:(id)arg1 module:(id)arg2 viewController:(id)arg3 workingRange:(unsigned long long)arg4;
- (id)initWithUserFeatureSets:(id)arg1 module:(id)arg2 viewController:(id)arg3;
