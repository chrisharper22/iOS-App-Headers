...
+ (id)tapModelsWithServerArray:(id)arg1 key:(id)arg2 objectStores:(id)arg3 upcomingEventStore:(id)arg4;
+ (id)tapModelWithServerDict:(id)arg1 key:(id)arg2 objectStores:(id)arg3 upcomingEventStore:(id)arg4;
