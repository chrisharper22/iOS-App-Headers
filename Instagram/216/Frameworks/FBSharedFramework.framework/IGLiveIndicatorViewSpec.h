...
+ (id)shopHomeLiveTileSpec;
+ (id)shoppingSellerManagementCreatorMediaSpec;
+ (id)igtvDiscoverSpec;
+ (id)storyCameraTabColorTextSpec;
+ (id)storyCameraTabFilledSpec;
+ (id)storyCameraTabWhiteBorderSpec;
+ (id)exploreCollectionSpec;
+ (id)traySpecBranding2021WithLabelContentType:(long long)arg1 grayed:(_Bool)arg2 hasBorder:(_Bool)arg3;
+ (id)traySpecWithLabelContentType:(long long)arg1 grayed:(_Bool)arg2 hasBorder:(_Bool)arg3;
+ (id)liveSubscribersHeaderSpec;
+ (id)livePracticeHeaderSpec;
+ (id)liveQAHeaderSpec;
+ (id)liveWorkHeaderSpec;
+ (id)liveDefaultHeaderSpec;
+ (id)liveQAHeaderSpecBranding2021;
+ (id)liveDefaultHeaderSpecBranding2021;
- (void).cxx_destruct;
