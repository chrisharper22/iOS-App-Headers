...
@protocol FBMediaNetworkDispatch, FBMediaOffProcessNetworkRequestProvider, FBMediaUploadCache, FBMediaUploadJobFactory, OS_dispatch_queue;
...
- (id)initWithUploadJobFactory:(id)arg1 networkDispatcher:(id)arg2 offProcessNetworkRequestProvider:(id)arg3 cache:(id)arg4 queue:(id)arg5 maxUploadJobsInflight:(unsigned long long)arg6;
- (id)initWithUploadJobFactory:(id)arg1 networkDispatcher:(id)arg2 offProcessNetworkRequestProvider:(id)arg3 cache:(id)arg4 queue:(id)arg5;
