...
@interface FBARLocaleServiceConfiguration : NSObject <FBARServiceConfiguration, FBARServiceConfigurationCxx>
{
...
- (void).cxx_destruct;
@property(readonly, nonatomic) id <FBARLocaleServiceDataSource> dataSource; // @synthesize dataSource=_dataSource;
