...
#import <FBSharedFramework/FNFAtomManager-Protocol.h>
...
@interface FNFMp4AtomManager : NSObject <FNFAtomManager>
{
    ...
    struct FNFMp4FrameMetadataCompressor *_frames[3];
...
- (id)initWithMoovAtomSize:(unsigned long long)arg1 enableMp4AssetSeekingFix:(_Bool)arg2 enableMp4AssetEditListSeekingFix:(_Bool)arg3 enableMp4AssetRotationSupport:(_Bool)arg4 enableWhatsAppStreaming:(_Bool)arg5 enableHEVCSupport:(_Bool)arg6 shouldCacheLoadedData:(_Bool)arg7 enableFrameAttributes:(_Bool)arg8 supportMultiParamSets:(_Bool)arg9;
- (void)dealloc;
