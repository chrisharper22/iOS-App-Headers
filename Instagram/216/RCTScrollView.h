...
@class NSArray, NSDictionary, NSHashTable, NSMutableArray, NSString, RCTCustomScrollView, UIScrollView, UIView;
...
@interface RCTScrollView : RCTView <RCTUIManagerObserver, UIScrollViewDelegate, RCTScrollableProtocol, RCTAutoInsetsProtocol>
{
    ...
    _Bool _automaticallyAdjustKeyboardInsets;
    _Bool _DEPRECATED_sendUpdatedChildFrames;
    _Bool _scrollToOverflowEnabled;
    _Bool _disableIntervalMomentum;
    _Bool _snapToStart;
    _Bool _snapToEnd;
    _Bool _inverted;
    int _snapToInterval;
...
@property(nonatomic) _Bool disableIntervalMomentum; // @synthesize disableIntervalMomentum=_disableIntervalMomentum;
...
@property(nonatomic) _Bool automaticallyAdjustKeyboardInsets; // @synthesize automaticallyAdjustKeyboardInsets=_automaticallyAdjustKeyboardInsets;
...
- (void)setAutomaticallyAdjustsScrollIndicatorInsets:(_Bool)arg1;
