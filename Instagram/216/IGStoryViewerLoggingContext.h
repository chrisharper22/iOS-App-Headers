...
@class IGAdItemMapper, IGFeedItemTracker, IGPhotosRenderedLogger, IGSessionTracker, IGSponsoredSupportConfiguration, IGStoryFalcoLoggerExperiments, IGStoryImpressionLoggingManager, IGStoryImpressionTwoMeasurementConfig, IGStoryMediaLoadingState, IGStoryMediaLoggingModel, IGStoryTrayViewModel, IGUserSession, NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSString;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) IGStoryMediaLoadingState *mediaLoadingState; // @synthesize mediaLoadingState=_mediaLoadingState;
...
- (void)_updateStoryDailyImpressionForEducationalTray;
- (void)_logSecondChannel:(id)arg1 storyItem:(id)arg2 impressionType:(unsigned long long)arg3;
...
- (id)extrasForBroadcast:(id)arg1 owner:(id)arg2 mediaType:(long long)arg3;
- (id)livePlaybackLoggerForBroadcast:(id)arg1 owner:(id)arg2 adaptiveBitrateUrl:(id)arg3;
