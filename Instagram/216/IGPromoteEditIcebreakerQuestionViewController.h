...
@interface IGPromoteEditIcebreakerQuestionViewController : IGPromoteViewController <IGListAdapterDataSource, UICollectionViewDelegate, IGDSPromoteTextInputSectionControllerDelegate, IGNavigationControllerDelegate, IGActionSheetControllerDelegate, IGPromoteTitleSubtitleSectionControllerDelegate>
{
    ...
    IGDSPromoteTextInputViewModel *_editQuestionViewModel;
...
- (void)_editServerError:(id)arg1;
- (void)_handleDeleteSuccess;
- (void)_handleSaveSuccess;
- (void)_handleServerError;
- (void)_deleteQuestionAtIndex:(unsigned long long)arg1;
- (void)_editQuestionAtIndex:(unsigned long long)arg1 newText:(id)arg2;
- (void)_reloadView;
...
- (void)viewDidLoad;
- (id)initWithSession:(id)arg1 dataStore:(id)arg2 logger:(id)arg3 index:(unsigned long long)arg4;
