...
@class IGRegistrationAccountLinkingWelcomeViewController;
...
- (void)registrationAccountLinkingWelcomeViewControllerDidTapContactPointButton:(IGRegistrationAccountLinkingWelcomeViewController *)arg1;
