...
@class IGDirectVisualMessagePlaybackTracker, IGDirectVisualMessageViewerLoggingInfo, IGPhotosRenderedLogger, IGUserSession, IGUserStore, NSDate, NSMutableDictionary, NSMutableOrderedSet, NSString;
...
- (void)logImageErrorForUrl:(id)arg1 storyId:(id)arg2 message:(id)arg3 error:(id)arg4 networkRequestSummary:(id)arg5;
...
- (void)notifyPlaybackDidEndForMessage:(id)arg1 atIndex:(long long)arg2;
- (void)notifyVideoDidPlayForMessage:(id)arg1;
- (void)notifyPlaybackDidStartForMessage:(id)arg1 atIndex:(long long)arg2;
- (void)notifyPlaybackDidLoadForMessage:(id)arg1 loadSource:(id)arg2 networkRequestSummary:(id)arg3;
- (void)notifyUnpauseForVisualMessage:(id)arg1;
- (void)notifyPause;
- (void)notifyWillLoadImageURL:(id)arg1 forMessage:(id)arg2;
- (void)notifyLoadingStateDidUpdateForMessage:(id)arg1 loadingState:(id)arg2;
