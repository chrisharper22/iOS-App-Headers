...
@class IGInfoCenterFactShareModel, IGUserSession, NSString;

@interface IGBloksActionNavigationFactShareDelegateHandler : NSObject <IGDirectShareSheetControllerDelegate>
{
...
- (id)initWithUserSession:(id)arg1 factShareModel:(id)arg2;
