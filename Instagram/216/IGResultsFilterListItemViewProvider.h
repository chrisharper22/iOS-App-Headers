...
@class IGCoreTextView, IGResultsFilterListItemDescriptionView, IGResultsFilterListItemViewModel, IGTableLayoutSpec, NSString;
@protocol IGListItemViewProviderDelegate;

@interface IGResultsFilterListItemViewProvider : NSObject <IGListItemViewProvider>
{
    IGTableLayoutSpec *_layoutSpec;
    IGCoreTextView *_textView;
    IGResultsFilterListItemDescriptionView *_descriptionView;
    _Bool selected;
    id <IGListItemViewProviderDelegate> providerDelegate;
    IGResultsFilterListItemViewModel *_viewModel;
    struct UIEdgeInsets _leadingViewInsets;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) IGResultsFilterListItemViewModel *viewModel; // @synthesize viewModel=_viewModel;
