...
@class IGContextualFeedViewController, IGMedia;

@protocol IGContextualFeedViewControllerDelegate <NSObject>
- (void)contextualFeedViewController:(IGContextualFeedViewController *)arg1 didChangePaginatedFocusToMedia:(IGMedia *)arg2;
