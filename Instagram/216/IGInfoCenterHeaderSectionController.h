...
@class IGInfoCenterHeaderCell, NSString;

@interface IGInfoCenterHeaderSectionController : IGListGenericSectionController <IGListDisplayDelegate>
{
    IGInfoCenterHeaderCell *_cell;
}
