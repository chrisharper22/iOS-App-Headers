...
@class NSHashTable, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, RCTBridge, RCTBundleManager, RCTCallableJSModules, RCTLayoutAnimationGroup, RCTModuleRegistry, RCTUIManagerObserverCoordinator, RCTViewRegistry;
...
+ (id)JSResponder;
+ (const struct RCTMethodInfo *)__rct_export__160019;
+ (const struct RCTMethodInfo *)__rct_export__155018;
+ (const struct RCTMethodInfo *)__rct_export__145817;
+ (const struct RCTMethodInfo *)__rct_export__144716;
+ (const struct RCTMethodInfo *)__rct_export__143315;
+ (const struct RCTMethodInfo *)__rct_export__141614;
+ (const struct RCTMethodInfo *)__rct_export__136613;
+ (const struct RCTMethodInfo *)__rct_export__133712;
+ (const struct RCTMethodInfo *)__rct_export__130411;
+ (const struct RCTMethodInfo *)__rct_export__110210;
+ (const struct RCTMethodInfo *)__rct_export__10789;
+ (const struct RCTMethodInfo *)__rct_export__10678;
+ (const struct RCTMethodInfo *)__rct_export__10597;
+ (const struct RCTMethodInfo *)__rct_export__10376;
+ (const struct RCTMethodInfo *)__rct_export__9765;
+ (const struct RCTMethodInfo *)__rct_export__8954;
+ (const struct RCTMethodInfo *)__rct_export__8633;
+ (const struct RCTMethodInfo *)__rct_export__8382;
+ (const struct RCTMethodInfo *)__rct_export__8201;
+ (const struct RCTMethodInfo *)__rct_export__7000;
