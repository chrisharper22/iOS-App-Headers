...
@class IGSingleFeedItemConfiguration, NSString;

@interface IGDirectFeedItemConfiguration : NSObject <IGFeedItemConfigurationType>
{
...
- (id)headerTheme;
- (id)theme;
- (id)initWithUserSession:(id)arg1 overridenCarouselPostItemPk:(id)arg2 shouldShowCallButtons:(_Bool)arg3;
