...
@class IGDirectQuickSendCellViewModel;

@interface IGDirectQuickSendSectionController : IGListBindingSingleSectionController
{
    IGDirectQuickSendCellViewModel *_item;
    struct IGGridLayoutConfiguration _layoutConfig;
}

- (void).cxx_destruct;
@property(retain, nonatomic) IGDirectQuickSendCellViewModel *item; // @synthesize item=_item;
