...
@class IGSingleFeedItemConfiguration, IGUserSession, NSString;

@interface IGMeOnlyFeedItemConfiguration : NSObject <IGFeedItemConfigurationType>
{
    IGSingleFeedItemConfiguration *_defaultConfig;
