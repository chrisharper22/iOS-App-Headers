...
@class IGDirectSuggestedMediaViewController, IGMedia, NSArray, NSString;
...
- (void)suggestedMediaViewController:(IGDirectSuggestedMediaViewController *)arg1 didSelectFeedItem:(IGMedia *)arg2 contentIndex:(unsigned long long)arg3 contentSource:(NSString *)arg4;
@end
