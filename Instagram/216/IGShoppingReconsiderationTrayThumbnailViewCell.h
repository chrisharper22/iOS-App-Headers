...
@class IGShoppingProductThumbnailImageView, NSString, UIView;

@interface IGShoppingReconsiderationTrayThumbnailViewCell : UICollectionViewCell <IGImageViewDelegate>
{
    double _thumbnailWidth;
    IGShoppingProductThumbnailImageView *_thumbnailImageView;
    UIView *_whiteBackgroundOverlayView;
}
...
- (void)configureWithViewModel:(id)arg1 thumbnailWidth:(double)arg2;
