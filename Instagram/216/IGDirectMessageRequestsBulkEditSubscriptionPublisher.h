...
@interface IGDirectMessageRequestsBulkEditSubscriptionPublisher : NSObject <IGDirectInboxCellSelectStateListener, IGDirectDataSubscriptionPublishing>
{
...
- (id)initWithUserSession:(id)arg1 cellSelectStateCoordinator:(id)arg2;
