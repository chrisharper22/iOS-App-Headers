...
@class IGAudioTrackClip, IGCameraAspectRatioOverlayView, IGCameraLoggingContext, IGCameraNavigationController, IGCameraViewController, IGCameraZoomController, IGStoryCameraOverlayViewController, IGStoryDrawerViewController, IGUserSession, NSString;
@protocol IGStoryFormatViewControllerProtocolDelegate;

@interface IGStoryFeedFormatViewController : UIViewController <IGStoryCameraOverlayViewControllerDelegate, IGCameraViewControllerDelegate, IGCameraZoomControllerDelegate, IGQuickCamCaptureButtonDelegate, IGFeedCreationFlowDelegate, UIGestureRecognizerDelegate, IGCameraNavigationControllerDelegate, IGPanavisionEditorDelegate, IGStoryFormatViewControllerProtocol>
{
...
- (void)cameraNavigationControllerDidTapCameraButton:(id)arg1;
- (void)cameraNavigationController:(id)arg1 didShowSelectAlbumVC:(_Bool)arg2;
- (void)cameraNavigationController:(id)arg1 didUpdateChildViewControllers:(id)arg2;
...
- (void)_presentFeedEditorWithVideo:(id)arg1;
- (void)_presentFeedEditorWithStoryMediaAsset:(id)arg1;
- (void)_dismissFeedGalleryChildVC:(_Bool)arg1;
- (void)_presentFeedGalleryAsChildVC:(_Bool)arg1;
- (void)_tryBeginRecording;
- (void)_tryStopRecording;
- (void)_saveOriginalPhotoIfNecessary:(id)arg1;
- (void)_takePicture;
...
- (_Bool)_showUpcomingEventAddedDialogIfNecessary;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithUserSession:(id)arg1 loggingContext:(id)arg2 upcomingEvent:(id)arg3 audioTrackClip:(id)arg4;
