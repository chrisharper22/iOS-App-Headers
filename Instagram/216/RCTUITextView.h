...
@class NSAttributedString, NSDictionary, NSString, RCTBackedTextViewDelegateAdapter, UIColor, UILabel, UITextInputPasswordRules, UITextPosition, UITextRange, UIView;
