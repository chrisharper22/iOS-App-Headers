...
@class IGFNFVideoPlayer, IGMedia, IGSessionTracker, IGShoppingPDPLightboxReelViewModel, IGStoryViewerPresentationController, IGUserSession, NSString;
@protocol IGShoppingPDPLightboxReelSectionControllerDelegate, IGStoryItemType;
...
@interface IGShoppingPDPLightboxReelSectionController : IGListSectionController <IGDropsProductStickerViewConsumptionDelegate, IGFNFVideoPlayerDelegate, IGListDisplayDelegate, IGShoppingPDPLightboxMediaCellDelegate>
{
    ...
    id <IGShoppingPDPLightboxReelSectionControllerDelegate> _delegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <IGShoppingPDPLightboxReelSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(readonly, nonatomic) id <IGStoryItemType> storyItem;
