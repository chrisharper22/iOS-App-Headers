...
@class IGFNFVideoPlayer, IGMediaPreloader, IGSessionTracker, IGShoppingConsumptionFeedItemLogger, IGShoppingPDPHeroCarouselFeedItemViewModel, IGShoppingPDPHeroCarouselMediaZoomController, IGUserSession, IGZoomViewPresenter, NSMutableDictionary, NSString;
...
@interface IGShoppingPDPHeroCarouselFeedItemSectionController : IGListSectionController <IGFNFVideoPlayerDelegate, IGListWorkingRangeDelegate, IGShoppingPDPHeroCarouselMediaCellDelegate, IGZoomLoggerProtocol>
{
    ...
    id <IGShoppingPDPHeroCarouselFeedItemSectionControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <IGShoppingPDPHeroCarouselFeedItemSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_handleFeaturedProductCancellationForFeaturedProduct:(id)arg1 mediaCarouselInfo:(id)arg2;
- (void)_preloadMedia;
- (void)_finishPlayingVideoIfNeeded;
- (void)_loadVideoIfNeeded;
- (id)_visibleCell;
- (id)_postItemForDisplay;
...
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 productItemPk:(id)arg2 logger:(id)arg3 sectionId:(id)arg4 shoppingSessionTracker:(id)arg5 viewpointLevel:(long long)arg6;
