...
#import "IGPromoteGridViewControllerDelegate-Protocol.h"
#import "IGPromoteMediaCropViewDelegate-Protocol.h"
...
- (void)_setCurrentAspectRatio:(double)arg1;
...
- (void)viewDidLoad;
- (id)initWithNonSquareEnabled:(_Bool)arg1 isFocused:(_Bool)arg2 userSession:(id)arg3 boostPostLogger:(id)arg4 title:(id)arg5;
- (id)initWithNonSquareEnabled:(_Bool)arg1 isFocused:(_Bool)arg2 userSession:(id)arg3 boostPostLogger:(id)arg4;
