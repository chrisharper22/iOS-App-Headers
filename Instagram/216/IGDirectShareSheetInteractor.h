...
@protocol IGAlertHUDHandling, IGDirectMessageSending, IGDirectShareSheetControlling;
...
@interface IGDirectShareSheetInteractor : NSObject <IGDirectShareSheetControllerDelegate, IGDirectMessageSendingListener>
{
    ...
    id <IGDirectMessageSending> _messageSendService;
    id <IGAlertHUDHandling> _alertHandler;
}

- (void).cxx_destruct;
- (void)_showAlertWithText:(id)arg1;
- (void)presentSharesheetWithTextMessage:(id)arg1;
