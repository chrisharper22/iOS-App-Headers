...
@interface BKBloksMediaUploadListener : NSObject <FBMediaUploadListener>
{
    CDUnknownBlockType _successHandler;
    CDUnknownBlockType _failureHandler;
    CDUnknownBlockType _progressUpdateHandler;
...
- (id)initWithSuccessHandler:(CDUnknownBlockType)arg1 failureHandler:(CDUnknownBlockType)arg2 progressUpdateHandler:(CDUnknownBlockType)arg3 cancellationHandler:(CDUnknownBlockType)arg4;
