...
@class IGDirectThreadDetailUserViewModel, IGUserSession;
@protocol IGDirectThreadDetailUserCellDelegate;

@interface IGDirectThreadDetailUserSectionController : IGListSectionController
{
