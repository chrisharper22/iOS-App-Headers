...
- (void)updateViewHeightTextDidChange:(_Bool)arg1;
...
- (void)dealloc;
- (id)initWithDefaultFont:(id)arg1 horizontalTextContainerPadding:(double)arg2 extraBottomPadding:(double)arg3 enableHeightChangeFix:(_Bool)arg4;
