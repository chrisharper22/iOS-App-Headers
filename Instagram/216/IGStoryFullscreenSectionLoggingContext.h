...
@interface IGStoryFullscreenSectionLoggingContext : NSObject <IGStoryFullscreenSectionLoggingContextType, IGGatingLoggingProviderDelegate>
{
    ...
    NSMapTable *_storyItemsToTapActions;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool useSelfView; // @synthesize useSelfView=_useSelfView;
...
@property(readonly, nonatomic) NSMapTable *storyItemsToTapActions; // @synthesize storyItemsToTapActions=_storyItemsToTapActions;
...
- (id)_analyticsModuleForStoryViewer;
...
- (id)_getNonPersonalisedFieldsForStoryItem:(id)arg1;
...
- (void)notifyDidTakeTapAction:(id)arg1 forStoryItem:(id)arg2;
- (void)notifyPanUpOnStoryForStoryItem:(id)arg1 panViewHeight:(double)arg2 panUpGestureLoggingModel:(id)arg3 extra:(id)arg4;
- (void)notifyTapOnDPAMediaForStoryItem:(id)arg1 pressPoint:(struct CGPoint)arg2 extra:(id)arg3;
...
- (void)notifyStorySuggestedFetchWithSuccess:(_Bool)arg1 isEmpty:(_Bool)arg2 httpStatus:(long long)arg3;
- (void)notifyStorySuggestedRepliesGifSelected:(id)arg1 category:(id)arg2 itemIndex:(long long)arg3;
- (void)notifyStorySuggestedRepliesGifRemoved:(id)arg1 category:(id)arg2;
- (void)notifyStorySuggestedRepliesCategorySelected:(id)arg1 category:(id)arg2;
- (void)notifyStorySuggestedRepliesScrollDidEnd:(id)arg1 category:(id)arg2 itemCount:(long long)arg3;
- (void)notifyStorySuggestedRepliesSheetPresented:(id)arg1;
- (void)notifyStoryReshareButtonTapForStoryItem:(id)arg1 reelOwner:(id)arg2 entryPoint:(long long)arg3 isEmojiReactionTrayVisible:(_Bool)arg4 navChain:(id)arg5;
...
- (void)notifyMessageSendForStoryItem:(id)arg1 isQuickReaction:(_Bool)arg2 isCustomQuickReaction:(_Bool)arg3 isSuggestedReply:(_Bool)arg4 isMoment:(_Bool)arg5;
- (void)notifyMessageDirectReplyComposeForStoryItem:(id)arg1;
- (void)notifyMessageComposeForStoryItem:(id)arg1 composerEntrypoint:(unsigned long long)arg2 isEmojiReactionTrayVisible:(_Bool)arg3 navChain:(id)arg4;
...
- (void)_notifyStoryStickerTapAttemptForStoryItem:(id)arg1 stickerType:(unsigned long long)arg2 stickerID:(id)arg3 extras:(id)arg4;
- (void)notifyFeedPostReshareTapWithMediaId:(id)arg1 productType:(id)arg2 forStoryItem:(id)arg3 tapPoint:(struct CGPoint)arg4 upcomingEventId:(id)arg5 fromContextSheet:(_Bool)arg6;
- (void)notifyFeedPostReshareNavWithMediaId:(id)arg1 productType:(id)arg2 forStoryItem:(id)arg3 upcomingEventId:(id)arg4 fromContextSheet:(_Bool)arg5;
- (void)notifyProductShareToolTipDidShowForProduct:(id)arg1 storyItem:(id)arg2 shoppingSessionID:(id)arg3;
- (void)notifyMultiProductTapWithProducts:(id)arg1 forStoryItem:(id)arg2;
- (void)notifyProductTapWithProduct:(id)arg1 forStoryItem:(id)arg2;
- (void)notifyProductToolTipDidShow:(id)arg1 forStoryItem:(id)arg2 shoppingSessionID:(id)arg3;
- (void)notifyLinkTooltipTappedWithLinkType:(id)arg1 url:(id)arg2 forStoryItem:(id)arg3;
- (void)notifyLinkStickerTappedWithLinkType:(id)arg1 forStoryItem:(id)arg2;
- (void)notifyLocationTapWithLocation:(id)arg1 locationId:(id)arg2 forStoryItem:(id)arg3 url:(id)arg4 fromContextSheet:(_Bool)arg5;
- (void)notifyCountdownTapped:(id)arg1 countdownId:(id)arg2 forStoryItem:(id)arg3 fromContextSheet:(_Bool)arg4;
- (void)notifyLocationTapped:(id)arg1 locationId:(id)arg2 forStoryItem:(id)arg3 fromContextSheet:(_Bool)arg4;
- (void)notifyMentionTapWithTaggedProfile:(id)arg1 forStoryItem:(id)arg2 url:(id)arg3 fromContextSheet:(_Bool)arg4;
- (void)notifyMentionTapped:(id)arg1 forStoryItem:(id)arg2 fromContextSheet:(_Bool)arg3;
- (id)getStoryAnalyticsContext:(id)arg1;
- (void)notifyBloksStickerTapWithModel:(id)arg1 forStoryItem:(id)arg2 stickerType:(id)arg3;
- (void)notifyHashtagTapWithTag:(id)arg1 forStoryItem:(id)arg2 url:(id)arg3 fromContextSheet:(_Bool)arg4;
- (void)notifyHashtagTapped:(id)arg1 didTapOnHashtagSticker:(_Bool)arg2 forStoryItem:(id)arg3 fromContextSheet:(_Bool)arg4;
...
- (void)notifyAttributionTapForStoryItem:(id)arg1 attributionTypes:(id)arg2;
...
- (void)notifyBloksMentionTapForStoryItem:(id)arg1 userId:(id)arg2;
...
- (id)videoLoggingDataProviderForStoryItem:(id)arg1 viewerSessionId:(id)arg2;
