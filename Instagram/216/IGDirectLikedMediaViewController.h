...
#import "IGDirectLikedMediaDataSourceDelegate-Protocol.h"
...
@class IGDirectLikedMediaDataSource, IGDirectMediaPickerLikedConfig, IGDirectMediaPickerLogger, IGEmptyFeedView, IGFeedScrollViewAnnouncer, IGInfoView, IGListAdapter, IGUserSession, NSMutableArray, NSString, UIButton, UICollectionView, UIView;
@protocol IGDirectLikedMediaViewControllerDelegate><IGDirectMediaPickerBackToBrowseDelegate;
...
@interface IGDirectLikedMediaViewController : IGViewController <IGDirectLikedMediaDataSourceDelegate, IGFeedScrollViewListener, IGPartialModalSheetListener, IGInfoViewDelegate, IGDirectScrollingTabChildViewControllerProtocol>
{
    ...
    double _bottomInset;
    id <IGDirectLikedMediaViewControllerDelegate><IGDirectMediaPickerBackToBrowseDelegate> _delegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <IGDirectLikedMediaViewControllerDelegate><IGDirectMediaPickerBackToBrowseDelegate> delegate; // @synthesize delegate=_delegate;
- (id)analyticsModule;
...
- (void)likedMediaDataSource:(id)arg1 didSelectFeedItem:(id)arg2 contentIndex:(unsigned long long)arg3;
