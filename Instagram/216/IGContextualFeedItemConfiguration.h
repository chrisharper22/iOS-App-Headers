...
@class IGCTAPresenterContext, IGCommentDraftDataController, IGDefaultFeedItemConfiguration, IGFeedItemShoppingConfiguration, IGMainFeedItemConfiguration, IGUserSession, NSString;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool hideUFIBar; // @synthesize hideUFIBar=_hideUFIBar;
...
- (id)initWithUserSession:(id)arg1 ctaPresenterContext:(id)arg2 showExploreContext:(_Bool)arg3 entryPoint:(long long)arg4 entityId:(id)arg5 productId:(id)arg6 emptyStateButtonTapBlock:(CDUnknownBlockType)arg7 showPreviewComments:(_Bool)arg8 supportIGTVAds:(_Bool)arg9 shoppingConfiguration:(id)arg10 hideUFIBar:(_Bool)arg11;
