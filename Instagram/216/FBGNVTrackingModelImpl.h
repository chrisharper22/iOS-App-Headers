...
#import "FBGNVTrackingModel-Protocol.h"

@class NSString;

@interface FBGNVTrackingModelImpl : NSObject <FBGNVTrackingModel>
{
    _Bool _isSponsored;
    NSString *_tracking;
...
- (id)initWithTracking:(id)arg1 destinationUri:(id)arg2 isSponsored:(_Bool)arg3 adId:(id)arg4 trackingToken:(id)arg5;
