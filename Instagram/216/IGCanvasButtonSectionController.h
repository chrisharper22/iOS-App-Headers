...
@class IGCanvasActionHelper, IGCanvasButtonViewModel, IGCanvasElementLogger, IGCanvasLoggingContext, NSString;

@interface IGCanvasButtonSectionController : IGListSectionController <IGCanvasButtonCellDelegate, IGListDisplayDelegate, IGCanvasActionConfigurable, IGCanvasComponentViewability>
{
