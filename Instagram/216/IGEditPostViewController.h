...
#import "IGEditBrandedContentPostHelperDelegate-Protocol.h"
...
@class IGAutocompleteController, IGCaptionLimitWarningController, IGContentWarningController, IGContentWarningNetworkSource, IGContentWarningPrefetchController, IGEditBrandedContentPostHelper, IGEditPostTextViewController, IGEditedPost, IGFeedItemHeader, IGKeyboardObserver, IGLeftAlignedFullWidthCTAButton, IGMedia, IGNavigationBar, IGShoppingTaggingPermissionsHelper, IGTextButton, IGTypeaheadSuggestionsController, IGUserSession, NSString, UIBarButtonItem, UIScrollView, UITapGestureRecognizer, UIView;
@protocol FBCancelable, IGEditPostViewControllerDelegate, IGFeedEditLoadedMediaProvider, IGTaggingViewConfiguration;

@interface IGEditPostViewController : IGViewController <IGAutocompleteControllerDelegate, IGBrandedContentSettingsViewControllerDelegate, IGEditAltTextViewControllerDelegate, IGEditPostTextViewControllerDelegate, IGFeedCarouselEditViewDelegate, IGFeedEditPhotoViewDelegate, IGFeedEditVideoViewDelegate, IGFeedItemHeaderDelegate, IGCaptionLimitWarningControllerDelegate, IGKeyboardObserverShowDelegate, IGKeyboardObserverHideDelegate, IGLocationPickerDelegate, IGShoppingTaggingPermissionsHelperDelegate, IGTaggingViewControllerDelegate, IGTypeaheadSuggestionsControllerDelegate, IGEditBrandedContentPostHelperDelegate, IGUpcomingEventDetailsViewControllerEditDelegate, UIGestureRecognizerDelegate>
{
...
@property(retain, nonatomic) IGLeftAlignedFullWidthCTAButton *collectionCTAButton; // @synthesize collectionCTAButton=_collectionCTAButton;
@property(retain, nonatomic) IGTextButton *upcomingEventTextButton; // @synthesize upcomingEventTextButton=_upcomingEventTextButton;
...
@property(retain, nonatomic) id <IGEditPostViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)feedCarouselEditView:(id)arg1 didDeletePostItemPk:(id)arg2;
...
- (void)_openCarouselTaggingViewControllerWithConfig:(id)arg1 fbUserTagDict:(id)arg2 igUserTagDict:(id)arg3 productItemTagDict:(id)arg4 coauthorUserTags:(id)arg5;
- (void)_openSingleMediaTaggingViewControllerWithConfig:(id)arg1 fbUserTags:(id)arg2 igUserTags:(id)arg3 productItemTags:(id)arg4 coauthorUserTags:(id)arg5;
- (id)_generateProductTaggingViewConfiguration;
- (id)_generateProductAndUserTaggingViewConfig;
- (void)_openProductTaggingViewController;
- (void)_openUserTaggingViewController;
- (void)_startProductTaggingFlow;
- (_Bool)_canUserAccessProductTagEditing;
...
- (void)_didFinishEditingPostWithRemovedFeaturedProduct:(id)arg1;
- (_Bool)_isCarousel;
...
- (void)_presentFinalFeaturedProductRemovalConfirmationForProduct:(id)arg1;
- (void)_presentFeaturedProductRemovalWarningForProduct:(id)arg1;
- (void)_scrollViewTapped:(id)arg1;
- (void)_mediaViewTapped:(id)arg1;
- (void)_didTapUpcomingEventTextButton:(id)arg1;
...
- (void)_prepareForEditPostRequest;
...
- (void)_disappearWithCurve:(long long)arg1 duration:(double)arg2 removedFeaturedProduct:(id)arg3;
- (void)_dismissWithRemovedFeaturedProduct:(id)arg1;
...
- (void)viewDidLoad;
- (id)initWithMedia:(id)arg1 userSession:(id)arg2 currentPage:(long long)arg3;
- (void)dealloc;
