...
@class IGQPMegaphone, IGUserSession, NSString, UIView;
@protocol IGQPActionHandlerProtocol, IGQPMegaphoneViewProtocol, IGQPViewPresenterDelegate;

@interface IGQPSocialContextMegaphoneViewPresenter : NSObject <IGQPMegaphoneViewDelegate, IGQPMegaphonePresenterProtocol>
{
