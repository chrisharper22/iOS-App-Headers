...
@class NSString;
@protocol IGTVDraftsThumbnailSectionControllerDelegate;

@interface IGTVDraftsThumbnailSectionController : IGListGenericSectionController <IGListDisplayDelegate>
{
    id <IGTVDraftsThumbnailSectionControllerDelegate> _delegate;
}
