...
{
    id <IGUpcomingEventCreateSectionControllerDelegate> _delegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <IGUpcomingEventCreateSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
