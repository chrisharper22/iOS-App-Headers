...
@class IGInsightsLiteralPageControl, IGTableLayoutSpec, NSString;
@protocol IGListItemViewProviderDelegate;

@interface IGInsightsLiteralPageControlViewProvider : NSObject <IGListItemViewProvider>
{
    _Bool _selected;
    IGTableLayoutSpec *_layoutSpec;
    id <IGListItemViewProviderDelegate> _providerDelegate;
    IGInsightsLiteralPageControl *_bodyContentView;
    struct UIEdgeInsets _leadingViewInsets;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) IGInsightsLiteralPageControl *bodyContentView; // @synthesize bodyContentView=_bodyContentView;
