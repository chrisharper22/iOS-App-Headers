...
@class IGDirectShareSheetToastHelper, IGProductItem, IGShoppingConsumptionFeedItemLogger, IGUserSession, IGViewController, NSString;
...
- (void)presentShareSheetForProductItem:(id)arg1 shouldBlockOverrideOfNavigationBarBackButton:(_Bool)arg2;
- (id)initWithLogger:(id)arg1 viewController:(id)arg2 userSession:(id)arg3;
