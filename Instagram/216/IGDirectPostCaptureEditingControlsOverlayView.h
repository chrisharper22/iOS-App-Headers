...
@class IGDirectCameraCreationViewMode, IGDirectStoryPreviewFooterConfigureSpec, IGEffectSlider, IGGradientColorToggleButton, IGGradientView, IGStoryCameraModeToggleView, IGStoryMediaCompositionState, IGStoryMultiEditCompositionThumbnailTray, IGStoryPostCaptureHeaderSpec, IGStoryPostCaptureHeaderView, IGVideoLayerListView, IGVideoTimelineView, NSString, UIControl, UIView;
...
@interface IGDirectPostCaptureEditingControlsOverlayView : IGPassthroughView <IGStoryMediaCompositionEditingControlsOverlayViewProtocol>
{
    ...
    IGDirectStoryPreviewFooterConfigureSpec *_defaultFooterSpec;
    ...
    UIView<IGDirectEphemeralityOptionsStoryPreviewFooterViewType> *_footerView;
...
@property(readonly, nonatomic) UIView<IGDirectEphemeralityOptionsStoryPreviewFooterViewType> *footerView; // @synthesize footerView=_footerView;
...
- (void)layoutSubviews;
- (id)initWithDirectCreationConfiguration:(id)arg1 defaultHeaderSpec:(id)arg2 defaultFooterSpec:(id)arg3 shouldHideEditOptions:(_Bool)arg4;
