...
@interface IGPermalinkFeedItemConfiguration : NSObject <IGFeedItemConfigurationType>
{
    IGSingleFeedItemConfiguration *_singleFeedItemConfiguration;
}
...
- (id)initWithSingleFeedItemConfiguration:(id)arg1;
