...
@class IGMedia, IGSessionTracker, IGShoppingBasicProductFeedTitleConfiguration, IGShoppingNavigationAnalyticsContext, IGSponsoredSupportConfiguration, IGUserSession, NSDictionary, NSString;

@interface IGShoppingVisualSearchResultsBasicProductFeedConfiguration : NSObject <IGShoppingBasicProductFeedViewControllerConfigurationType>
{
...
- (id)initWithUserSession:(id)arg1 title:(id)arg2 media:(id)arg3 analyticsModule:(id)arg4 priorModule:(id)arg5 entryPoint:(long long)arg6 sponsoredSupportConfiguration:(id)arg7 shoppingSessionTracker:(id)arg8 detectedObjectId:(id)arg9;
