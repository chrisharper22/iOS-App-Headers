...
@class IGMainFeedItemConfiguration, IGSingleFeedItemConfiguration, NSString;

@interface IGPBIAProxyProfileFeedItemConfiguration : NSObject <IGFeedItemConfigurationType>
{
    IGSingleFeedItemConfiguration *_singleItemConfig;
    IGMainFeedItemConfiguration *_mainItemConfig;
...
- (id)initWithUserSession:(id)arg1 shouldShowUFI:(_Bool)arg2;
