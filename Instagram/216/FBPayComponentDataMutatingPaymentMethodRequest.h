...
@class FBPayPaymentMethod;

@interface FBPayComponentDataMutatingPaymentMethodRequest : FBValueObject <NSCopying, NSCoding>
{
...
- (id)initWithMutationType:(long long)arg1 paymentMethod:(id)arg2;
