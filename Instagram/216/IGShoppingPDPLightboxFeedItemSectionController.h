...
@class IGFNFVideoPlayer, IGSessionTracker, IGShoppingPDPLightboxFeedItemViewModel, IGUserSession, NSString;
@protocol IGShoppingPDPLightboxFeedItemSectionControllerDelegate;

@interface IGShoppingPDPLightboxFeedItemSectionController : IGListSectionController <IGFNFVideoPlayerDelegate, IGListDisplayDelegate, IGShoppingPDPLightboxMediaCellDelegate>
{
    ...
    id <IGShoppingPDPLightboxFeedItemSectionControllerDelegate> _delegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <IGShoppingPDPLightboxFeedItemSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
