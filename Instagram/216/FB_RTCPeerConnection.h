...
@class FB_RTCConfiguration, FB_RTCPeerConnectionFactory, FB_RTCSessionDescription, NSArray, NSMutableArray;
...
@interface FB_RTCPeerConnection : NSObject
{
    ...
    struct unique_ptr<webrtc::PeerConnectionDelegateAdapter, std::default_delete<webrtc::PeerConnectionDelegateAdapter>> _observer;
    scoped_refptr_1f0d680a _peerConnection;
    unique_ptr_04eba08e _nativeConstraints;
    _Bool _hasStartedRtcEventLog;
    id <FB_RTCPeerConnectionDelegate> _delegate;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(readonly, nonatomic) FB_RTCPeerConnectionFactory *factory; // @synthesize factory=_factory;
@property(nonatomic) __weak id <FB_RTCPeerConnectionDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)setBitrateAllocationStrategy:(unique_ptr_e9998c85)arg1;
