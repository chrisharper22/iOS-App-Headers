...
#import "IGShareProfileViewControllerDelegate-Protocol.h"

@class IGNUXFlowContext, NSString, UIViewController;
@protocol IGNUXFlowCoordinatorProtocol;

@interface IGNUXShareProfileStepController : NSObject <IGShareProfileViewControllerDelegate, IGNUXStepControllerProtocol>
{
...
- (void)shareProfileViewControllerDidShareProfile:(id)arg1;
- (void)shareProfileViewControllerDidTapSkip:(id)arg1;
- (id)stepName;
- (id)viewController;
