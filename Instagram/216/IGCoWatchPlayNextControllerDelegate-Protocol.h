...
@protocol IGCoWatchPlayNextControllerDelegate <NSObject>
...
- (void)playNextControllerDidSelectMedia:(id <IGCoWatchableMedia>)arg1 tabSource:(NSString *)arg2 itemIndex:(unsigned long long)arg3;
@end
