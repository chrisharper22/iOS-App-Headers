...
#import "FB_RTCPeerConnectionDelegate-Protocol.h"
...
- (id)createPeerConnectionFactory:(void *)arg1 withAudioDeviceLoggerDelegate:(id)arg2;
- (id)initWithUserId:(id)arg1 peerConnectionConfig:(CDStruct_42cde6ea)arg2 delegate:(id)arg3 perfLoggingDelegate:(id)arg4 audioDeviceLoggingDelegate:(id)arg5;
