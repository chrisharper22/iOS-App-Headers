...
- (void)liveMainViewControllerDidFinishSession:(IGLiveBroadcastMainViewController *)arg1 afterSuccessfulBroadcasting:(_Bool)arg2 sharedToIGTV:(_Bool)arg3 startNewLive:(_Bool)arg4;
