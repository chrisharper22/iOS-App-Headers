...
@class IGAddAccountManager, IGGenericMegaphoneViewV2, IGUserSession, NSString, UIView;
@protocol IGGenericMegaphoneLogger, IGMegaphonePresenterDelegate;

@interface IGFinstaPromotionMegaphonePresenter : NSObject <IGGenericMegaphoneViewV2Delegate, IGMegaphonePresenterProtocol>
{
