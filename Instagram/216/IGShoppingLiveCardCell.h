...
@class CALayer, IGLiveIndicatorView, IGLiveMediaPlayerView, NSDictionary, NSString, UILabel;
@protocol IGLiveCardCellDisplayingDelegate, IGStoryPlayerMediaViewType;

@interface IGShoppingLiveCardCell : UICollectionViewCell <IGLiveCardCellDisplaying>
{
    IGLiveMediaPlayerView *_mediaView;
    IGLiveIndicatorView *_liveIndicatorView;
    CALayer *_highlightOverlay;
    UILabel *_offerAttributionLabel;
