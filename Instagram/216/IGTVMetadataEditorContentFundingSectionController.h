...
{
    id <IGTVMetadataEditorContentFundingSectionControllerDelegate> _delegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <IGTVMetadataEditorContentFundingSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
