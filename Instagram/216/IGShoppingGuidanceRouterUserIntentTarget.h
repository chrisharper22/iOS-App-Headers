...
@interface IGShoppingGuidanceRouterUserIntentTarget : NSObject <FBIntentTarget>
{
...
- (id)initWithDestination:(id)arg1 entryPoint:(id)arg2 priorModule:(id)arg3 waterfallID:(id)arg4;
