...
@property(retain, nonatomic) UIColor *borderEndColor; // @synthesize borderEndColor=_borderEndColor;
@property(retain, nonatomic) UIColor *borderStartColor; // @synthesize borderStartColor=_borderStartColor;
