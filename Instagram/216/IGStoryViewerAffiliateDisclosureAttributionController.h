...
@interface IGStoryViewerAffiliateDisclosureAttributionController : NSObject <IGStoryViewerHeaderAttributionType>
{
    NSString *_disclosureTag;
}
...
- (id)initWithAffiliateInfo:(id)arg1;
