...
@class IGRingViewSpec, IGStoryReelOwner, IGStoryRingBadgeSpec, NSArray, NSAttributedString, NSData, NSString, NSURL;
...
@interface IGStoryTrayCellViewModel : FBValueObject <IGListDiffable, NSCopying, NSCoding>
{
    ...
    _Bool _showUnseenBadge;
    _Bool _useLiveBranding2021;
    ...
    NSArray *_stackedAvatarUsers;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool useLiveBranding2021; // @synthesize useLiveBranding2021=_useLiveBranding2021;
@property(readonly, copy, nonatomic) NSArray *stackedAvatarUsers; // @synthesize stackedAvatarUsers=_stackedAvatarUsers;
@property(readonly, nonatomic) _Bool showUnseenBadge; // @synthesize showUnseenBadge=_showUnseenBadge;
...
@property(readonly, copy, nonatomic) IGStoryRingBadgeSpec *ringBadgeSpec; // @synthesize ringBadgeSpec=_ringBadgeSpec;
